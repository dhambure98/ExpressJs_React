...
connection.connect(function(err){
    if(err){
        ...
        var userTableQuery = "CREATE TABLE IF NOT EXISTS items (code VARCHAR(255) PRIMARY KEY, name VARCHAR(255), description Varchar(255), price double, qtyOnHand int(10))"
